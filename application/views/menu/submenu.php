                ...
                <tbody>
                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                            <a href="#" class="badge badge-success badge-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</a>
                            <a href="<?= base_url('menu/hapus/') . $sm['id'] ?>" onclick="confirm('Yakin mau dihapus?'); " class="badge badge-danger badge-sm tombol-hapus">Delete</button>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
